...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/yanami1.png",
			"assets/images/DesktopWallpaper/yanami2.png",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/yanami1.png",
			"assets/images/MobileWallpaper/yanami2.jpg",
		],
	},
	// Banner模式特有配置
	banner: {
